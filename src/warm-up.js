...
var sequel = title + " 2: 2 Gravitational 2 Rainbowy"

//title + " 2: 2 Gravitational 2 Rainbow";
...
if (pages >= 25) { isShortStory = false;
  console.log(isShortStory);
  console.log("It's not a short story");
}
else { isShortStory = true;
  console.log(isShortStory);
  console.log("It's a short story.");
}
...
var books = ["V.", "The Crying of Lot 49", "Mason & Dixon", "Against the Day",
"Vineland"]
...
var belowTwoHundred = [12, 15, 17, 20, 34, 56, 78, 80, 91, 93, 95, 98]
